...
<body>
	...
	<form action="./commonCodeInsertGroup.ino">
		<table border="1">
			<tbody>
				<tr>
					<td style="width: 150px;"align="center">그룹코드 :</td>
					<td style="width: 400px;"><input type="text" name="grCode"/> ex) GR001,GR002</td>
				</tr>
				<tr>
					<td style="width: 150px;"align="center">코드명 :</td>
					<td style="width: 400px;"><input type="text" name="grCodeName"/> ex)글타입, 검색조건 </td>
				</tr>
				<tr>
